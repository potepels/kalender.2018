    ...
    <div className="t_about">
        ...
        <div className="g_center-content">
            <div className="t_about__text">
                ...
                <p>Har du en kommentar eller noe på hjertet, kan du slenge meg en e-post på post@potepels.com. PS: hvis du bruker Internet Explorer og ting ser litt rart ut, så bytt nettleser. For din egen del. Internett er mye penere når en ikke bruker Internet Explorer.</p>
                <p>SLENG INN ET BILDE AV DEG SELV, SØTA HE HE. Med bisker.</p>
            </div>
        </div>
    </div>
);
